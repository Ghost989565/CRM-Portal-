...
export function ClientsListView({ clients, onClientSelect, onRefresh }: ClientsListViewProps) {
    ...
    <div className="space-y-4">
      ...
      {selectedClients.length > 0 && (
        <div className="flex items-center gap-2 p-3 bg-muted/30 rounded-lg">
          ...
          <Button size="sm" variant="outline" className="text-foreground border-border hover:bg-accent hover:text-accent-foreground">
            Bulk Tag
          </Button>
          <Button size="sm" variant="outline" className="text-foreground border-border hover:bg-accent hover:text-accent-foreground">
            Update Status
          ...
          <TableBody>
            {filteredClients.length === 0 ? (
              ...
              filteredClients.map((client) => (
                <TableRow key={client.id} className="group hover:bg-muted/30 cursor-pointer" onClick={() => onClientSelect(client)}>
                  ...
                  <TableCell onClick={(e) => e.stopPropagation()}>
                    <div className="flex space-x-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      <Button size="sm" variant="ghost" className="h-8 w-8 p-0" onClick={() => handleAction("call", client)}>
                        <Phone className="h-4 w-4" />
                      </Button>
                      <Button size="sm" variant="ghost" className="h-8 w-8 p-0" onClick={() => handleAction("text", client)}>
                        <MessageSquare className="h-4 w-4" />
                      </Button>
                      <Button size="sm" variant="ghost" className="h-8 w-8 p-0" onClick={() => handleAction("email", client)}>
